...
#         print('sequence_output:', sequence_output) #这是last hidden states 看看是不是和下面一样
        hidden_states = outputs[2]
#         print('hidden_states.len',len(hidden_states))
#         sequence_output_1 = hidden_states[1]
#         sequence_output_2 = hidden_states[2]
#         sequence_output_3 = hidden_states[3]
#         sequence_output_4 = hidden_states[4]
#         sequence_output_5 = hidden_states[5]
#         sequence_output_6 = hidden_states[6]
#         sequence_output_7 = hidden_states[7]
#         sequence_output_8 = hidden_states[8]
#         sequence_output_9 = hidden_states[9]
        sequence_output_10 = hidden_states[10]
        sequence_output_11 = hidden_states[11]
        sequence_output_12 = hidden_states[12] #这是第12层的hidden_states
        
        sequence_output =[]
        sequence_output.append(sequence_output_12)
        sequence_output.append(sequence_output_11)
        sequence_output.append(sequence_output_10)
#         sequence_output.append(sequence_output_9)
#         print('sequence_output_12:', sequence_output_12)
        logits = self.classifier(sequence_output)
...
#         self.out_proj = nn.Linear(config.hidden_size*4, config.num_labels) #四层拼接
        self.out_proj = nn.Linear(config.hidden_size*3, config.num_labels) #三层拼接
#         self.out_proj = nn.Linear(config.hidden_size*2, config.num_labels) #三层拼接
...
#         return x
        ...
        x_3 = features[2]
#         x_4 = features[3]
        x_1 = x_1[:, 0, :]  # take <s> token (equiv. to [CLS])
        x_2 = x_2[:, 0, :]
        x_3 = x_3[:, 0, :]
#         x_4 = x_4[:, 0, :]
