...
#         print('iterator.batch_size',iterator.batch_size)
        ...
        if i % 10000 == 0:
            ...
            output_dir = '/data1/home/zmj/roberta/trained_model/duoceng12attention/trained_model/snli_lr1e5_maxlen256_wd0_th/epoch'+str(epoch_num)+'step'+str(i)
...
#         每个epoch保存一次模型
    ...
    model.save_pretrained('/data1/home/zmj/roberta/trained_model/duoceng12attention/trained_model/snli_lr1e5_maxlen256_wd0_th/epoch'+str(i+1))
