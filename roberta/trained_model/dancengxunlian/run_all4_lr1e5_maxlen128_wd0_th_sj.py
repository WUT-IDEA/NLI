...
#         print('iterator.batch_size',iterator.batch_size)
        ...
        if i % 10000 == 0:
            ...
            output_dir = '/data1/home/zmj/roberta/trained_model/dancengxunlian/trained_model/4_snli_lr1e5_maxlen128_wd0_th_sj/epoch'+str(epoch_num)+'step'+str(i)
...
tb = SummaryWriter(log_dir = "runs/4_snli_lr1e5_maxlen128_wd0_th_sj")
# tb.add_graph(model)
...
#         每个epoch保存一次模型
    ...
    model.save_pretrained('/data1/home/zmj/roberta/trained_model/dancengxunlian/trained_model/4_snli_lr1e5_maxlen128_wd0_th_sj/epoch'+str(i+1))
