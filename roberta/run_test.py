...
file_name = 'snli_score_predicted'
out_dir = '/data1/home/zmj/roberta/trained_model/snli_lr1e5_maxlen128_wd1e2_3/epoch4step10000/'
...
model_name ="/data1/home/zmj/roberta/trained_model/snli_lr1e5_maxlen128_wd1e2_3/epoch4step10000/"
num_labels = 6
...
data_files = {"train":data_dir+"snlitrain.csv", "dev":data_dir+"snlidev.csv", "test":data_dir+"snlitest.csv"}
...
# dev_dataloader = DataLoader(tokenized_datasets['dev'], collate_fn=dc, **params)
